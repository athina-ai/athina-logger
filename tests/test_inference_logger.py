...
@pytest.mark.parametrize(
    ...
    [
        # first test case: includes all fields
        (
                "gpt-4",
                [
                    {
                ...
                {"temperature": 1, "max_completion_tokens": 10, "stop": ["apollo", "mars"], "top_p": 1}
        ),
        # second test case: omitting model_options as an optional param
        (
                "gpt-4",
                [
                    {
                ...
                "ref-101112",
                {"company": "OpenAI", "links": ["https://openai.com"]},
                None  # `model_options` not included for optional param testing
        )
    ]
)
